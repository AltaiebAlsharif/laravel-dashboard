<!--Action Button-->
@if( Active::checkUriPattern( 'admin/renters' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.renters.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.renters.all' ) }}
            </a>
        </li>
        @permission( 'create-renter' )
            <li>
                <a href="{{ route( 'admin.renters.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.renters.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
