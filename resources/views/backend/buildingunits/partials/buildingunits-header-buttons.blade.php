<!--Action Button-->
@if( Active::checkUriPattern( 'admin/buildingunits' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.buildingunits.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.buildingunits.all' ) }}
            </a>
        </li>
        @permission( 'create-buildingunit' )
            <li>
                <a href="{{ route( 'admin.buildingunits.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.buildingunits.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
