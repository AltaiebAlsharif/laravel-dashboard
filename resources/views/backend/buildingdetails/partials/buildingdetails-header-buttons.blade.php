<!--Action Button-->
@if( Active::checkUriPattern( 'admin/buildingdetails' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.buildingdetails.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.buildingdetails.all' ) }}
            </a>
        </li>
        @permission( 'create-buildingdetail' )
            <li>
                <a href="{{ route( 'admin.buildingdetails.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.buildingdetails.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
