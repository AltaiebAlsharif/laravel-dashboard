<!--Action Button-->
@if( Active::checkUriPattern( 'admin/buildingtypes' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.buildingtypes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.buildingtypes.all' ) }}
            </a>
        </li>
        @permission( 'create-buildingtype' )
            <li>
                <a href="{{ route( 'admin.buildingtypes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.buildingtypes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
