<!--Action Button-->
@if( Active::checkUriPattern( 'admin/buildings' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.buildings.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.buildings.all' ) }}
            </a>
        </li>
        @permission( 'create-building' )
            <li>
                <a href="{{ route( 'admin.buildings.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.buildings.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
