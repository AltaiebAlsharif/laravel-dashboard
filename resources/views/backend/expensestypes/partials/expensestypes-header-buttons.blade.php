<!--Action Button-->
@if( Active::checkUriPattern( 'admin/expensestypes' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.expensestypes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.expensestypes.all' ) }}
            </a>
        </li>
        @permission( 'create-expensestype' )
            <li>
                <a href="{{ route( 'admin.expensestypes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.expensestypes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
